...
Finally, sometimes, we want to add extra information to a message
...
<p><code>"about": "The user-agent that sent this request."</code>
<code>},</code></p>
...
- We could allow the serialization of arrays of objects.  However, this
